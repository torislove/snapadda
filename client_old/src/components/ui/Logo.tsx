    ...
    >
      ...
      >
        ...
        >
          ...
          {/* Left Tower */}
          <rect x="80" y="160" width="60" height="190" rx="5" ry="5" fill="rgba(255,255,255,0.18)" stroke="url(#goldGrad)" strokeWidth="3" />
          {/* Right Tower */}
          <rect x="260" y="160" width="60" height="190" rx="5" ry="5" fill="rgba(255,255,255,0.18)" stroke="url(#goldGrad)" strokeWidth="3" />
          {/* Shiny Windows */}
        ...
        {showText && (
          <div className="logo-text-wrap" style={{ display: 'flex', alignItems: 'center', fontFamily: "'Inter', sans-serif", textDecoration: 'none' }}>
            <span 
